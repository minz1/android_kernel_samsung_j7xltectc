...
//ALRAN 
static DEFINE_CLK_VOTER(pnoc_buspm_clk, &pnoc_clk.c, LONG_MAX); //0 
static DEFINE_CLK_VOTER(snoc_buspm_clk, &snoc_clk.c, LONG_MAX); //1 
static DEFINE_CLK_VOTER(cnoc_buspm_clk, &sysmmnoc_clk.c, LONG_MAX); //2 use "cnoc" from albus tool for sysmmnoc control at 8976 
...
static DEFINE_CLK_VOTER(cnoc_buspm_a_clk, &sysmmnoc_a_clk.c, LONG_MAX); 
