...
panel_power_ctrl:
#if defined(CONFIG_FB_MSM_MDSS_SAMSUNG)
	/* disable SAMSUNG_GPIO_CONTROL0,1 */
	mdss_samsung_dsi_pinctrl_set_state(ctrl_pdata, SAMSUNG_GPIO_CONTROL0, false);
	mdss_samsung_dsi_pinctrl_set_state(ctrl_pdata, SAMSUNG_GPIO_CONTROL1, false);
#endif
...
int mdss_dsi_on(struct mdss_panel_data *pdata)
{
	...
	/* enable SAMSUNG_GPIO_CONTROL0,1 */
	mdss_samsung_dsi_pinctrl_set_state(ctrl_pdata, SAMSUNG_GPIO_CONTROL0, true);
	mdss_samsung_dsi_pinctrl_set_state(ctrl_pdata, SAMSUNG_GPIO_CONTROL1, true);
#endif
